...
namespace Final
{
    public partial class superior : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                cmd = new MySqlCommand("insert into superior(name,email,number,checkin,checkout,roomcount) values(@a1,@a2,@a3,@a4,@a5,@a6)", con);
            ...
            Response.Redirect("Billingsuperior.aspx");
        }
