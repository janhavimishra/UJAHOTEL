<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="luxury.aspx.cs" Inherits="Final.luxury" %>
...
<head runat="server">
  ...
  <body>
    <section class="section-book">
     ...
     <div class="form__group">
    <input type="number" class="form__input" placeholder="Mobile Number" name="number" id="num">
...
.section-book {
  height: 100vh;
  background-image: linear-gradient(to right bottom, #141E61, #787A91 );
}
