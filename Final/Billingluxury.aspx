<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Billingluxury.aspx.cs" Inherits="Final.Billingluxury" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Luxury Billing</title>
</head>
<body>
    <form id="form1" runat="server">
        <br /><br /><h1>Luxury Rooms Billing</h1>
        <div>
            <div class="container">
        <div class="part1">
            <fieldset>
